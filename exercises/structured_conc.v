...
Proof.
  ...
  *)
  ...
  - iIntros (Φ') "!> _ HΦ'".
    ...
    by iApply "HΦ'".
  - iIntros "%Φ'". iIntros "!> Htrue H".
    iInv "I" as "(%n & Hr & >%Hn)".
    wp_faa.
    iModIntro.
    iSplitL "Hr".
    + iExists (n + 6)%Z.
      iFrame. iPureIntro. apply Zeven_plus_Zeven; done.
    + iApply "H". iFrame.
  - done.
  - iIntros "%v1 %v2 [HT1 HT2]". wp_seq.
    iInv "I" as "(%n & Hr & >%Hn)".
    wp_load. iModIntro. iSplitL "Hr".
    + iExists (n)%Z. iModIntro. iFrame. iPureIntro. assumption.
